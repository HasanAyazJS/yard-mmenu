...
const best = require('best-tools');//ADAM
...
client.on("ready", async () => {
  ...
  client.user.setActivity(`${prefix}yardım | ${client.guilds.size} Sunucu Ve ${client.guilds.reduce((a, b) => a + b.memberCount, 0).toLocaleString()} Kullanıcı İçin Teşekkürler!`, { type: 'PLAYING' });
